...
class TestOptions():
    ...
    def initialize(self):
        self.parser.add_argument("--opt_path", type=str, default='./checkpoints/kit/kit_condunet1d_batch64/opt.txt',help='option file path for loading model')
        self.parser.add_argument("--gpu_id", type=int, default=0, help='GPU id')

        # evaluator
        self.parser.add_argument("--evaluator_dir", type=str, default='data/', help='Directory path where save T2M evaluator\'s checkpoints')
